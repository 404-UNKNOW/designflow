  ...
  return (
    <div className="max-w-4xl mx-auto p-2 sm:p-6">
      <div className="flex flex-col sm:flex-row justify-between items-center mb-8 gap-4">
        ...
        <button className="px-4 py-2 sm:px-5 sm:py-2 bg-green-600 text-white rounded-lg font-semibold shadow hover:bg-green-700 transition w-full sm:w-auto">新建客户</button>
      </div>
